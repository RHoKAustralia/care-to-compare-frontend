...
export const extrasInclusionsOptions = [
...
export const hospitalInclusionsOptions = [
  ...
  {
    label: 'Surgical Weight Loss Procedures',
    value: 'SURGICAL_WEIGHT_LOSS_PROCEDURES',
  },
  { label: 'Sterilisation', value: 'STERILISATION' },
  {
    label: 'Non Cosmetic Plastic Surgery',
    value: 'NON_COSMETIC_PLASTIC_SURGERY',
  },
