    ...
    <form onSubmit={handleSubmit}>
      <div>
        ...
        >
          ...
          <option value="One adult &amp; any dependants">
            Single and Dependants
          </option>
          <option value="One adult &amp; dependant(s)">
            Single any Dependants
          </option>
          <option value="Two adults">Couples</option>
          <option value="Two adults &amp; any dependants">
            Couples any Dependants
          </option>
          <option value="Two adults &amp; dependant(s)">
